...
from currency_converter.app.exceptions import ConversionErrorException, ValidationServiceException
...
class ConversionService:
    ...
    def convert(self, conversion_request: ConversionRequest) -> Transaction:
        ...
        try:
            ...
            recorded_transaction = self.transaction_service.record_transaction(transaction)
