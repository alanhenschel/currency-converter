...
class TestConversionService:
    ...
    def test_convert_success(self):
        ...
        self.mock_transaction_service.record_transaction.return_value = (
            saved_transaction
        )
        ...
        self.mock_currency_api.get_exchange_rate.assert_called_once_with(
            conversion_request
        )
    ...
    def test_convert_zero_amount_raises_validation_error(self):
        ...
        # Arrange
        conversion_request = ConversionRequest(
            from_currency="USD", to_currency="BRL", amount=0.0
        )
    ...
    def test_convert_negative_amount_raises_validation_error(self):
        ...
        # Arrange
        conversion_request = ConversionRequest(
            from_currency="USD", to_currency="BRL", amount=-10.0
        )
    ...
    def test_convert_currency_api_error_raises_conversion_error(self):
        ...
        self.mock_currency_api.get_exchange_rate.side_effect = ConversionErrorException(
            "API timeout"
        )
    ...
    def test_convert_transaction_service_error_raises_conversion_error(self):
        ...
        self.mock_transaction_service.record_transaction.side_effect = Exception(
            "Database error"
        )
    ...
    def test_convert_calculates_correct_amount(self):
        ...
        # Arrange
        conversion_request = ConversionRequest(
            from_currency="EUR", to_currency="USD", amount=50.0
        )
        ...
        def capture_transaction(transaction):
            ...
            assert (
                abs(transaction.to_value - 55.0) < 0.001
        ...
        self.mock_transaction_service.record_transaction.side_effect = (
            capture_transaction
        )
